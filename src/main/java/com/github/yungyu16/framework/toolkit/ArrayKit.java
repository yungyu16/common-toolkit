...
public class ArrayKit {
    ...
    public static Object[] defaultIfNull(Object[] array, Class defaultComponentType) {
        return array == null ? (Object[]) ((Object[]) Array.newInstance(
                ClassKit.getNonPrimitiveType(defaultComponentType), 0)) : array;
    }
    ...
    public static Object[] defaultIfEmpty(Object[] array, Class defaultComponentType) {
        return array != null && array.length != 0 ? array : (Object[]) ((Object[]) Array
                .newInstance(ClassKit.getNonPrimitiveType(defaultComponentType), 0));
    }
        ...
        if (array != null && arrayToFind != null) {
            ...
            if (startIndex >= sourceLength) {
                ...
                if (targetLength == 0) {
                    ...
                    while (true) {
                        while (i > max || ObjectKit.equals(array[i], first)) {
                            if (i > max) {
                                return -1;
                            }
                            ...
                            } while (ObjectKit.equals(array[j++], arrayToFind[var10++]));
        ...
        if (array != null && arrayToFind != null) {
            ...
            if (startIndex < 0) {
                ...
                if (targetLength == 0) {
                    ...
                    while (true) {
                        while (i < min || ObjectKit.equals(array[i], last)) {
                            if (i < min) {
                                return -1;
                            }
                            ...
                            } while (ObjectKit.equals(array[j--], arrayToFind[var12--]));
    ...
    private static void toString(StringBuffer buffer, Object array, String nullArrayStr,
        ...
        if (array == null) {
            ...
            buffer.append(ObjectKit.toString(array, nullElementStr));
        } else {
            buffer.append('[');
            int length;
            int i;
